...
const EditFaq = (props: Props) => {
  ...
  const newFaqHandler = () => {
    setQuestions([
      ...questions,
      {
        _id: Date.now().toString(), // fallback ID if not coming from backend
        question: "",
        answer: "",
        active: true,
      },
  ...
  if (!data?.layout) return <div className="text-center mt-20 text-red-500">No layout data found.</div>;
